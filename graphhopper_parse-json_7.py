...
key = "98cf47cb-42ec-4df0-93f8-19f42d646f96"   
...
while True:
    ...
    if vehicle == "salir" or vehicle == "s":
        ...
        vehicle = "car"
        print("No se ha introducido un perfil de vehículo válido. Uso del perfil del vehículo.")
    ...
    if orig[0] == 200 and dest[0] == 200:
        ...
        if paths_status == 200:
            ...
            print("Duración del viaje: {0:01d}:{1:01d}:{2:01d}".format(hr, min, sec))
            print("=================================================")
